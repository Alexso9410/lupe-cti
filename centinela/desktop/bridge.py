...
from centinela.analysis import analyze_ioc
from centinela.config import get_settings
from centinela.db import Database
from centinela.enrichment import run_enrichment
from centinela.export.obsidian import export_ioc_to_obsidian, save_obsidian_note
from centinela.ioc_detect import detect_ioc
from centinela.models import EnrichmentResult, IOC
...
class CentinelaAPI:
    ...
    def export_case_obsidian(self, case_id: int, output_dir: str) -> dict[str, Any]:
        ...
        try:
            ...
            for ioc_row in iocs:
                from centinela.models import IOCType, Severity
    ...
    def analyze_email_file(
        ...
        """
        try:
            from centinela.email_analyzer import analyze_email
            from centinela.email_parser import parse_eml
            ...
            if export_pdf_dir:
                from centinela.export.pdf_report import generate_email_report
