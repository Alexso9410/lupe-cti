"""Tests for Flet Settings view validation and persistence."""
...
class TestSettingsValidation:
    ...
    def test_validate_openai_key_valid(self):
        ...
        from lupe.flet.views.settings import validate_key_format
...
class TestSettingsPersistence:
    ...
    def test_save_creates_config_file(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(
            "lupe.flet.views.settings._get_config_path", lambda: str(tmp_path / "lupe.toml")
        )
        settings = {
            "llm_provider": "openai",
    ...
    def test_save_creates_parent_dirs(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("lupe.flet.views.settings._get_config_path", lambda: str(config_path))
    ...
    def test_load_returns_empty_when_no_file(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(
            "lupe.flet.views.settings._get_config_path",
            lambda: str(tmp_path / "nonexistent.toml"),
        )
    ...
    def test_roundtrip_save_load(self, tmp_path, monkeypatch):
        ...
        from lupe.flet.views.settings import load_settings, save_settings
